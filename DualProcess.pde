...
}                                                     //utilisé pour la detection des touches.
void keyReleased() {
        joueur1.setMove(keyCode, false);
}                                                     //utilisé pour la detection des touches.
void mousePressed() {
        holdingMouse=true; if(mouseButton == LEFT) {joueur1.shoot(false, bullets1);}
}
void mouseReleased() {
        holdingMouse=false; joueur1.hold(holdingTime, true, bullets1); holdingTime=0;
}
/*=================================================================================*/
